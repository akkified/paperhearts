              ...
              <div className="md:col-span-3 space-y-6">
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="p-3 bg-white/5 hover:bg-pink-400 hover:text-[#3a223a] transition-all rounded-full"><Instagram size={20} /></a>
                    <a href="#" className="p-3 bg-white/5 hover:bg-pink-400 hover:text-[#3a223a] transition-all rounded-full"><Linkedin size={20} /></a>
                    <a href="#" className="p-3 bg-white/5 hover:bg-pink-400 hover:text-[#3a223a] transition-all rounded-full"><Mail size={20} /></a>
                  </div>
                </div>
